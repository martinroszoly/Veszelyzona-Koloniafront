/* V77 — larger, consistent map unit icons for every side. */
(function(){
  const W=42,H=36,COUNT_Y=38;
  ...
  style.textContent=`
    ...
    #battleView .map-unit-marker>span{filter:drop-shadow(0 1px 2px rgba(0,0,0,.95))!important;image-rendering:auto!important}
    #battleView .map-unit-marker>b{font-family:Inter,ui-sans-serif,system-ui,sans-serif!important;font-weight:900!important;letter-spacing:0!important;white-space:nowrap!important;box-shadow:0 1px 3px rgba(0,0,0,.7)!important}
  `;
  ...
  function normalizeUnitMarkers(){
    ...
    map.querySelectorAll('.territory-token[data-sector]').forEach(token=>{
      ...
      marker.style.setProperty('top','-22px','important');
      marker.style.setProperty('width',W+'px','important');
      marker.style.setProperty('height',H+'px','important');
      marker.style.setProperty('min-width',W+'px','important');
      marker.style.setProperty('min-height',H+'px','important');
      marker.style.setProperty('max-width',W+'px','important');
      marker.style.setProperty('max-height',H+'px','important');
      ...
      if(art){
        ...
        art.style.setProperty('width',W+'px','important');
        art.style.setProperty('height',H+'px','important');
        art.style.setProperty('min-width',W+'px','important');
        art.style.setProperty('min-height',H+'px','important');
        art.style.setProperty('max-width',W+'px','important');
        art.style.setProperty('max-height',H+'px','important');
        art.style.setProperty('transform','translateX(-50%)','important');
        art.style.setProperty('background-size','100% 100%','important');
      ...
      if(count){
        ...
        count.style.setProperty('padding','2px 5px','important');
        ...
        count.style.setProperty('font-size','7px','important');
