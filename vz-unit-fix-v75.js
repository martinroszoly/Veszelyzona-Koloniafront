...
(function(){
  ...
  style.textContent=\`
    ...
    #battleView #sectorMap>.field-unit-v88{
      ...
      overflow:visible!important;pointer-events:none!important;z-index:240!important;
    }
    #battleView #sectorMap>.field-unit-v88 .field-unit-art-v88{
      position:absolute!important;left:0!important;bottom:0!important;
      width:66px!important;height:60px!important;
      transform:translateX(-50%)!important;transform-origin:50% 100%!important;
      background-repeat:no-repeat!important;background-position:center bottom!important;background-size:contain!important;
      filter:drop-shadow(0 4px 3px rgba(0,0,0,.7))!important;
    }
    #battleView #sectorMap>.field-unit-v88 .field-unit-count-v88{
      position:absolute!important;left:0!important;top:4px!important;transform:translateX(-50%)!important;
      padding:2px 5px!important;border-radius:999px!important;background:rgba(3,10,15,.94)!important;
      border:1px solid rgba(220,238,246,.5)!important;color:#fff!important;
      font:900 7px/1 Inter,system-ui,sans-serif!important;white-space:nowrap!important;
    }
    @media(max-width:700px){
  ...
  function renderFieldUnitsV88(){
    ...
    state.grid.forEach(sector=>{
      ...
      if(sector.unit.side==='neutral' && String(state.selected)!==String(sector.id))return;
      const root=document.createElement('span');
      root.className='field-unit-v88 side-'+sector.unit.side;
      root.dataset.sector=sector.id;
      root.style.setProperty('left',sector.x+'%','important');
      root.style.setProperty('top',sector.y+'%','important');
      const art=document.createElement('span');
      art.className='field-unit-art-v88';
      art.style.setProperty('background-image',"url('"+artFor(sector.unit)+"')",'important');
      const count=document.createElement('b');
      count.className='field-unit-count-v88';
      count.textContent=Number(sector.unit.count||0).toLocaleString('hu-HU');
      root.append(art,count);
