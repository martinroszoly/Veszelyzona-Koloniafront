...
function renderBattle(){
  ...
  const markers=state.grid.map(sector=>{
    ...
    const guard=showUnit?(()=>{const neutral=sector.unit.side==='neutral',w=neutral?68:30,h=neutral?58:26,y=neutral?63:30;return `<span class="map-unit-marker" style="position:absolute!important;left:0!important;top:0!important;width:${w}px!important;height:${h}px!important;overflow:visible!important;z-index:999!important;pointer-events:none!important" title="${neutral?'Zsoldos őrség':typeName(sector.unit)} · ${sector.unit.count.toLocaleString('hu-HU')}"><span style="display:block!important;position:absolute!important;left:0!important;top:0!important;width:${w}px!important;height:${h}px!important;background-image:url('${artFor(sector.unit)}')!important;background-size:100% 100%!important;background-repeat:no-repeat!important;background-position:center!important;z-index:1000!important"></span><b style="display:block!important;position:absolute!important;left:50%!important;top:${y}px!important;transform:translateX(-50%)!important;min-width:30px!important;padding:2px 5px!important;border-radius:999px!important;background:#061018!important;color:#fff!important;font-size:7px!important;line-height:1!important;text-align:center!important;z-index:1001!important">${sector.unit.count.toLocaleString('hu-HU')}</b></span>`;})():'';
